package com.pp.common.utils.poi;

import com.pp.common.annotation.Excel;
import com.pp.common.annotation.Excels;
import com.pp.common.config.CommonConfig;
import com.pp.common.exception.GlobalException;
import com.pp.common.utils.page.AjaxResult;
import com.pp.common.utils.reflect.ReflectUtils;
...
//                        }
    ...
    public AjaxResult exportExcel() {
        ...
        try {
            ...
            throw new GlobalException("导出Excel失败，请联系网站管理员！");
        } finally {
            if (wb != null) {
                try {
                    wb.close();
